...
// prevEpNum/nextEpNum/epNums/watchBase are computed the same way the PHP
// version did (see computePlayerEpisodeNav in watch.ts) and passed in.
  ...
  <div id="sp-panel">
    ...
    <div id="sp-panel-body">
      ...
      <div class="sp-psec active" id="sp-ptab-eps">
        ...
        <!-- Episode grid: 24 visible, rest revealed + scrollable on Show More -->
${epGridHtml}
      </div>
