...
#senshi-player-root{
  ...
  background:var(--sp-bg, #05070d);
  font-family:var(--sp-body, 'Exo 2',sans-serif);
  border-radius:var(--sp-r, 14px);
  box-shadow:0 0 0 1px var(--sp-border, rgba(232,69,60,0.15)),0 0 28px rgba(232,69,60,0.07);
  overflow:hidden;
}
...
.sp-spin{width:46px;height:46px;border-radius:50%;border:2.5px solid transparent;border-top-color:var(--sp-accent, #e8453c);border-bottom-color:rgba(232,69,60,0.2);animation:sp-spin .75s linear infinite;box-shadow:0 0 12px var(--sp-accent-glow, rgba(232,69,60,0.4))}
...
.sp-err-title{font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.85rem;letter-spacing:.06em;color:#fff}
.sp-err-msg{font-size:.78rem;color:var(--sp-text-sub, rgba(232,234,240,0.6));line-height:1.5;max-width:320px}
.sp-err-retry{font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.7rem;letter-spacing:.08em;padding:.4rem 1.4rem;background:var(--sp-accent, #e8453c);color:#fff;border:none;border-radius:8px;cursor:pointer;transition:opacity .15s}
...
#sp-topbar{
  ...
  padding:8px 14px;background:var(--sp-surface, #0f1219);
  border-bottom:1px solid var(--sp-border, rgba(232,69,60,0.15));
}
.sp-top-title{font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.68rem;font-weight:500;letter-spacing:.05em;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.sp-top-ep{font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.56rem;letter-spacing:.07em;color:rgba(232,69,60,.7);margin-top:2px}
#sp-hls-badge{font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.5rem;letter-spacing:.14em;color:rgba(232,69,60,.7);border:1px solid rgba(232,69,60,.25);border-radius:4px;padding:2px 6px;background:rgba(232,69,60,.06);flex-shrink:0}

/* ─── INFO PANEL (below video) — UNCHANGED ─────────────────── */
#sp-panel{
  background:var(--sp-surface, #0f1219);
  border-top:1px solid var(--sp-border, rgba(232,69,60,0.15));
...
.sp-istat-sep{width:1px;height:12px;background:var(--sp-border, rgba(232,69,60,0.15));margin:0 3px;flex-shrink:0}

#sp-istat-float-tip{
  position:absolute;
  background:rgba(8,10,18,.97);border:1px solid var(--sp-border, rgba(232,69,60,0.15));
...
/* ── Tabs ───────────────────────────────────────────────── */
#sp-panel-tabs{display:flex;border-bottom:1px solid var(--sp-border, rgba(232,69,60,0.15))}
.sp-ptab{
...
.sp-ptab.active{color:var(--sp-accent, #e8453c);border-bottom-color:var(--sp-accent, #e8453c)}
...
.sp-ep-nav-btn{
  ...
  border:1px solid var(--sp-border, rgba(232,69,60,0.15));border-radius:9px;
...
.sp-ep-nav-btn:hover{border-color:var(--sp-accent, #e8453c);color:#fff;background:rgba(232,69,60,.07)}
...
.sp-ep-chip{
  ...
  border:1px solid var(--sp-border, rgba(232,69,60,0.15));border-radius:7px;
...
.sp-ep-more{
  ...
  background:var(--sp-surface2, #161b26);border:1px solid var(--sp-border, rgba(232,69,60,0.15));
...
.sp-ep-more:hover{border-color:var(--sp-accent, #e8453c);color:#fff;background:rgba(232,69,60,.08)}
...
.sp-qopt{padding:10px 8px;background:var(--sp-surface2, #161b26);border:1px solid var(--sp-border, rgba(232,69,60,0.15));border-radius:8px;cursor:pointer;text-align:center;transition:all .18s}
.sp-qopt:hover{border-color:var(--sp-accent, #e8453c);background:rgba(232,69,60,.06)}
.sp-qopt.active{border-color:var(--sp-accent, #e8453c);background:rgba(232,69,60,.12)}
...
.sp-sopt{padding:10px 4px;background:var(--sp-surface2, #161b26);border:1px solid var(--sp-border, rgba(232,69,60,0.15));border-radius:8px;cursor:pointer;text-align:center;font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.68rem;color:var(--sp-text-muted, rgba(232,234,240,0.35));transition:all .18s}
.sp-sopt:hover{border-color:var(--sp-accent, #e8453c);color:var(--sp-text, #e8eaf0)}
.sp-sopt.active{border-color:var(--sp-accent, #e8453c);color:var(--sp-accent, #e8453c);background:rgba(232,69,60,.1);text-shadow:0 0 8px rgba(232,69,60,.35)}
...
.sp-stat-item span{color:var(--sp-accent, #e8453c)}
#sp-buf-chart{height:48px;background:var(--sp-surface2, #161b26);border:1px solid var(--sp-border, rgba(232,69,60,0.15));border-radius:8px;overflow:hidden;display:flex;align-items:flex-end;padding:5px;gap:2px}
...
.sp-kbd{background:var(--sp-surface3, #1e2535);border:1px solid var(--sp-border, rgba(232,69,60,0.15));border-radius:4px;padding:3px 8px;font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.58rem;color:var(--sp-accent, #e8453c);white-space:nowrap;flex-shrink:0}
